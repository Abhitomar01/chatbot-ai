...
const API_KEY="AIzaSyAVOqLvIPBoFab7lHiZ7Fx6NXjkGGhDnMI"
...
//genrate the message of the bot ai 
...
fileCancleButton.addEventListener("click",()=>{
    userData.file = {};
    fileCancleButton.classList.remove("file-uploaded")
});
